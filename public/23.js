...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    box.ondrop = function (e) {
      ...
      (_this$files = _this.files).push.apply(_this$files, _toConsumableArray([].slice.call(files, 0).filter(function (_ref) {
        var name = _ref.name;
        return _this.ALLOWED_FILE_EXTENSIONS.indexOf(name.slice(name.lastIndexOf('.') + 1)) > -1;
      })));
    };
  },
  computed: {
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 11;
                return _this2.$http.post(route('store-asigment'), data);
    ...
    handleFilesUpload: function handleFilesUpload(e) {
      ...
      (_this$files2 = this.files).push.apply(_this$files2, _toConsumableArray([].slice.call(files, 0)));
    },
              ...
              [
                ...
                _c("ul", [
                  ...
                  _c("li", [
                    _vm._v(
                      "\n                            Formatos:\n                            " +
                        _vm._s(_vm.allowedFileExtensions.toUpperCase()) +
                        "\n                        "
                    )
                  ])
                ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { attrs: { for: "files" } }, [
