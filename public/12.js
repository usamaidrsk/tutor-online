          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.prev = 4;
                _context.next = 7;
                return _this.$http.post("questions/".concat(_this.step), data);

              case 7:
                window.location.href = route('questions', _this.step + 1);
                _context.next = 13;
                break;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                data = _this.form;
                _context.next = 8;
                return _this.$http.post('questions/2', data);

              case 8:
                window.location.href = route('questions', 3);
                _context.next = 15;
                break;
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h5", { staticClass: "margin-bottom--zero" }, [
      _vm._v("\n            Número de teléfono\n            "),
      _c("span", { staticClass: "text--gray" }, [_vm._v(" (opcional)")])
    ])
  },
  function() {
    var _vm = this
