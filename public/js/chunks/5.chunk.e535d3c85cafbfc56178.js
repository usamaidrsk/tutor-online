...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Conflict: __webpack_require__(/*! ./_create/Conflict */ "./resources/js/pages/asigment/_create/Conflict.vue")
  },
  ...
  methods: {
    handleSubmit: function handleSubmit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var form, data, date, time, _time$split$map, _time$split$map2, hours, minutes, url, validationErrors, message, isDuplicated;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 33:
                isDuplicated = /Duplicate entry/.test(message);

                if (isDuplicated) {
                  window.location.href = route('asigment.conflict');
                }
...
//# sourceMappingURL=5.chunk.e535d3c85cafbfc56178.js.map