        ...
        : _c(
            ...
            [
              _vm._l(_vm.rooms, function(room, index) {
                return _c("div", { key: index, staticClass: "room col-md-6" })
              }),
              _vm._v(" "),
              _c("a", { attrs: { href: _vm.route("room", _vm.room.token) } }, [
                _c("span", [
                  _vm._v(_vm._s(_vm.formatDistance(_vm.room.asigment.date)))
                ])
              ])
            ],
            2
...
//# sourceMappingURL=2.chunk.abb4395b80142a6a93e8.js.map