  ...
  methods: {
    handleSubmit: function handleSubmit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var form, data, date, time, _time$split$map, _time$split$map2, hours, minutes, url;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 22:
                ...
                _this2.errors.set(!(function webpackMissingModule() { var e = new Error("Cannot find module '~@/utils/handleValidationError'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(_context.t0));
...
//# sourceMappingURL=18.chunk.3f35520b2a8e23cab6ed.js.map