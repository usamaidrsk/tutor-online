  ...
  methods: {
    handleSubmit: function handleSubmit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var form, data, date, time, _time$split$map, _time$split$map2, hours, minutes, url, message, isDuplicated, validationErrors;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 22:
                ...
                if (_context.t0.response) {
                  message = _context.t0.response.message;
                  isDuplicated = message.match();
                  "SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry 'foo@bar.com' for key 'asigments_email_unique' (SQL: insert into `asigments` (`email`, `phone`, `budget`, `details`, `date`, `level_id`, `category_id`, `updated_at`, `created_at`) values (foo@bar.com, +5815654865, 5, corporis culpa! Cum? Error laborum neque vitae labore repellat quam quia voluptatem? Repellendus illum ex maxime consequatur pariatur sequi quo sint dolorum, 2020-05-18 15:45:00, 2, 1, 2020-05-11 22:19:25, 2020-05-11 22:19:25))";
                }
...
//# sourceMappingURL=5.chunk.47a60a8d87437a8a0737.js.map