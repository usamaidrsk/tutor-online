  ...
  methods: {
    handleSubmit: function handleSubmit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var form, data, date, time, _time$split$map, _time$split$map2, hours, minutes, url, validationErrors, isDuplicated;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 28:
                isDuplicated = _this2.isDuplicationError();
    ...
    isDuplicationError: function isDuplicationError(error) {
      var message = error.response && error.response.data.message;
      if (!message) return false;
      return /Duplicate entry/.test(message);
    }
  }
});
...
//# sourceMappingURL=5.chunk.11e9e5983bf64eee28fa.js.map