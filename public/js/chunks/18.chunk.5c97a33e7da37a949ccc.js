  ...
  methods: {
    handleSubmit: function handleSubmit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var form, data, date, time, _time$split$map, _time$split$map2, hours, minutes, url, response, errors;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 19:
                ...
                console.log(response.data); // window.location.href = route('asigment.index')
...
//# sourceMappingURL=18.chunk.5c97a33e7da37a949ccc.js.map