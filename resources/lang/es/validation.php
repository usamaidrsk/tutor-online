...
return [
    ...
    'after_or_equal' =>
        'Este campo debe ser una fecha posterior o igual a :date.',
    ...
    'before_or_equal' =>
        'Este campo debe ser una fecha anterior o igual a :date.',
    'between' => [
    ...
    'date_format' =>
        'Este campo no corresponde con el formato de fecha :format.',
    ...
    'ends_with' =>
        'Este campo debe finalizar con alguno de los siguientes valores: :values',
    ...
    'gte' => [
        ...
        'file' => 'Este archivo debe pesar :value o más kilobytes.',
    ...
    'lte' => [
        ...
        'file' => 'Este archivo debe pesar :value o menos kilobytes.',
    ...
    'required_if' =>
        'Este campo es obligatorio cuando el campo :other es :value.',
    'required_unless' =>
        'Este campo es requerido a menos que :other se encuentre en :values.',
    'required_with' =>
        'Este campo es obligatorio cuando :values está presente.',
    'required_with_all' =>
        'Este campo es obligatorio cuando :values están presentes.',
    'required_without' =>
        'Este campo es obligatorio cuando :values no está presente.',
    'required_without_all' =>
        'Este campo es obligatorio cuando ninguno de los campos :values están presentes.',
